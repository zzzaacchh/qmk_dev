...
[_NUMPAD] = LAYOUT_preonic_2x2u ( \
  ...
  KC_TAB,  KC_P,    KC_UP,   KC_J,    KC_NO,   KC_LBRC, KC_TAB, KC_7,    KC_8,    KC_9,    KC_PLUS,  KC_EQL, \
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |  UP  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  GUI | B/L  | Menu |     Alt     |    Space    | Ctrl | Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_GAMING] = LAYOUT_preonic_2x2u ( \
  ...
  KC_LCTL, KC_LGUI, LO_BACK, FN_MENU, KC_LALT, KC_SPACE, RAISE, KC_LEFT, KC_DOWN, KC_RGHT \
),
...
[_FUNCTION] = LAYOUT_preonic_2x2u ( \
  ...
  KC_ESC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_A,    KC_LPRN, KC_RPRN, KC_4,    KC_5,    KC_6,    KC_PLUS,  KC_COMM, \
  KC_LSFT, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE,KC_LCBR, KC_RCBR, KC_1,    KC_2,    KC_3,    KC_ENT,   KC_RCTL, \
  KC_MYCM, KC_CALC, KC_LALT, KC_APP, LO_BACK, RS_SPACE, KC_0, KC_DOT, KC_APP,  KC_RALT \
),
...
[_RAISE] = LAYOUT_preonic_2x2u ( \
  ...
  DM_RSTP, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE,  KC_LCBR, KC_RCBR,  KC_NUHS, KC_NUBS, KC_QUES, KC_VOLU, _______, \
  DM_REC1, DM_REC2, DM_PLY1, DM_PLY2, LOWER, RAISE, KC_MNXT, KC_VOLD, KC_VOLD, KC_MPLY \
),
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|AudOff|AGnorm|AGswap|Qwerty|Numpad|GAMING|      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_2x2u ( \
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY, NUMPAD, GAMING,  _______, _______, \
